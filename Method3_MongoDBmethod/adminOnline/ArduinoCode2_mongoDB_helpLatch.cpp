...
const char* webSocketServerAddress = "esp8266-control.onrender.com"; // Your Render app's domain
const int webSocketServerPort = 443; // Standard port for HTTPS
...
void setup() {
  ...
  webSocket.beginSSL(webSocketServerAddress, webSocketServerPort, webSocketServerPath);
